...
def args_parser():
    ...
    parser.add_argument('--alg', type=str, default='fedehald', help="algorithms")
    parser.add_argument('--mode', type=str, default='model_heter', help="mode")
    ...
    parser.add_argument('--ld', type=float, default=1, help="weight of FedHALD loss")
    parser.add_argument('--ft_round', type=int, default=10, help="round of fine tuning")
    # 2/16 牛牛
    parser.add_argument('--tau', type=float, default=1, help="tau for contrast")
    parser.add_argument('--algo', type=str, default='mine', help="tau for contrast")
    parser.add_argument('--lag', type=bool, default=True, help="explore the number of labels or not")
    parser.add_argument('--t_global', type=bool, default=False, help="using the FedHALDs to test the global data")
    parser.add_argument('--var', type=bool, default=False, help="是否逐渐变化")
    parser.add_argument('--ldc', type=float, default=1, help="对比学习正则项")
    parser.add_argument('--k', type=int, default=20, help="对比学习正则项")
    parser.add_argument('--lambda1', type=float, default=0.5, help="公共数据集")
